...
<script src="${basePath}/static/plugins/bootstrap3-dialog/js/bootstrap-dialog.js"></script>
...
<script src="${basePath}/static/plugins/sweetalert/sweetalert.min.js"></script>
<script src="${basePath}/static/plugins/webuploader/0.1.5/webuploader.min.js"></script>
<script	src="${basePath}/static/plugins/jquery.validation/1.14.0/jquery.validate.js"></script>
<script	src="${basePath}/static/plugins/jquery.validation/1.14.0/validate-methods.js"></script>
